                                                    ...
                                                    if (isset($_COOKIE['fname']) && isset($_COOKIE['bday']))
                                                     {
                                                        ...
                                                        //Taurus
                                                            ...
                                                            echo "Taurus is the second sign of the zodiac covering the period from April 20 to May 20.";
                                                        }
                                                        //Gemini
                                                        else if(($monthWord == "May" && $day >= 21) || ($monthWord == "June" && $day <= 20)) {
                                                            echo "Gemini is the third sign of the zodiac covering the period from  May 21 to  June 21.";
                                                        }
                                                        //Libra
                                                        else if(($monthWord == "September" && $day >= 23) || ($monthWord == "October" && $day <= 22)) {
                                                            echo "Libra is the seventh sign of the zodiac covering the period from  September 22 to  October 23. ";
                                                        }

                                                        //Cancer
                                                        else if(($monthWord == "June" && $day >= 21) || ($monthWord == "July" && $day <= 22)) {
                                                            echo "Cancer is the fourth sign of the zodiac covering the period from  June 22 to  July 22. ";
                                                        }

                                                        //Pisces
                                                        else if(($monthWord == "February" && $day >= 19) || ($monthWord == "March" && $day <= 20)) {
                                                            echo "Pisces is the 12th sign of the zodiac covering the period from  February 19 to  March 20. ";
                                                        }

                                                        //Aries
                                                        else if(($monthWord == "March" && $day >= 21) || ($monthWord == "April" && $day <= 19)) {
                                                            echo "Aries is the first sign of the zodiac covering the period from  March 21 to  April 19. ";
                                                        }

                                                        //Scorpio
                                                        else if(($monthWord == "October" && $day >= 23) || ($monthWord == "November" && $day <= 21)) {
                                                            echo "Scorpio is the eighth sign of the zodiac covering the period from  October 24 to  November 21.";
                                                        }

                                                        //Sagittarius
                                                        else if(($monthWord == "November" && $day >= 22) || ($monthWord == "December" && $day <= 21)) {
                                                            echo "Sagittarius is the ninth sign of the zodiac covering the period from  November 22 to  December 21.";
                                                        }

                                                        //Capricorn
                                                        else if(($monthWord == "December" && $day >= 22) || ($monthWord == "January" && $day <= 19)) {
                                                            echo "Capricorn is the 10th sign of the zodiac covering the period from  December 22 to  January 19.";
                                                        }
